        ...
        <div className="card stack">
          ...
          <div className="grid" style={{ gap: "0.75rem" }}>
            <div className="stack">
              ...
              <strong style={{ fontSize: "1.6rem" }}>Awaiting data</strong>
              <span className="tiny muted">Open vs. resolved counts will render here with tenant scoping.</span>
            </div>
            <div className="divider" />
            <div className="stack">
              <span className="muted tiny">Documents</span>
              <strong style={{ fontSize: "1.6rem" }}>Uploads</strong>
          ...
          <div className="grid" style={{ gap: "0.75rem" }}>
            <div className="stack accent-rail">
              ...
              <span className="muted tiny">
                Point your frontend fetcher at <code>NEXT_PUBLIC_API_URL</code> and hydrate these cards with real
                data.
              </span>
            </div>
            <div className="divider" />
      ...
      <div className="hero-bento">
        ...
        <div className="bento-card">
          ...
          <div className="stack" style={{ gap: "0.45rem" }}>
            ...
            <div className="tiny muted">
              Uploads are tenant-aware and refresh the list live after a successful POST.
            </div>
            <div className="stat-bar" aria-hidden>
              <span style={{ width: "55%" }} />
            </div>
        ...
        <div className="bento-card">
          ...
          <div className="stack" style={{ gap: "0.4rem" }}>
            ...
            <div className="tiny muted">Use the AI page to chat, optionally persist memory, and inspect the JSON responses.</div>
          </div>
        </div>
      </div>
    </section>
